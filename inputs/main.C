...
//*
//* Copyright 2024, North Carolina State University * ALL RIGHTS RESERVED
...
main()
{
  ...
  std::cout << inputs::utils::typeName<std::string>() << std::endl;
  ...
  //                return outcome::failure("Custom species names must begin with upper case
  //                letters.");
  //            }
  ...
  //            {
  //              if (mass <= 0)
  //                return outcome::failure("Species masses must be non-zero positive
  //                numbers.");
  //            }
  //            return outcome::success();
  //          }),
  ...
  //
  //  declareRequiredParam("common", "a parameter both need", block_base,
  //  std::vector<std::string>);
  //
